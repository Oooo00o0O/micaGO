...
type MessageJSON struct {
	...
	AssociatedMessageType  *int64  `json:"associatedMessageType,omitempty"` // Tapback: 2000-2006 add / 3000-3006 remove.
	AssociatedMessageGUID  *string `json:"associatedMessageGuid,omitempty"` // tapback target (p:/bp: prefixed)
	AssociatedMessageEmoji *string `json:"associatedMessageEmoji,omitempty"`
